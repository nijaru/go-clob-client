...
func TestRFQErrorCodes(t *testing.T) {
	...
	codes := map[RFQErrorCode]string{
		...
		RFQCodeInvalidOrderSide:                         "INVALID_ORDER_SIDE",
		RFQCodeInvalidSignatureType:                     "INVALID_SIGNATURE_TYPE",
		RFQCodeMissingMakerAddressInQuote:               "MISSING_MAKER_ADDRESS_IN_QUOTE",
		RFQCodeMissingMakerAmountInSignedOrder:          "MISSING_MAKER_AMOUNT_IN_SIGNED_ORDER",
		RFQCodeMissingMakerInSignedOrder:                "MISSING_MAKER_IN_SIGNED_ORDER",
		RFQCodeMissingQuoteID:                           "MISSING_QUOTE_ID",
		RFQCodeMissingRFQID:                             "MISSING_RFQ_ID",
		RFQCodeMissingSaltInSignedOrder:                 "MISSING_SALT_IN_SIGNED_ORDER",
		RFQCodeMissingSignatureInSignedOrder:            "MISSING_SIGNATURE_IN_SIGNED_ORDER",
		RFQCodeMissingSignerAddressInQuote:              "MISSING_SIGNER_ADDRESS_IN_QUOTE",
		RFQCodeMissingSignerInSignedOrder:               "MISSING_SIGNER_IN_SIGNED_ORDER",
		RFQCodeMissingTakerAmountInSignedOrder:          "MISSING_TAKER_AMOUNT_IN_SIGNED_ORDER",
		RFQCodeMissingTimestampInSignedOrder:            "MISSING_TIMESTAMP_IN_SIGNED_ORDER",
		RFQCodeMissingTokenIDInSignedOrder:              "MISSING_TOKEN_ID_IN_SIGNED_ORDER",
		RFQCodeOrderSideOrTokenDoesNotMatchRequest:      "ORDER_SIDE_OR_TOKEN_DOES_NOT_MATCH_REQUEST",
		RFQCodePriceE6NotPositive:                       "PRICE_E6_NOT_POSITIVE",
		RFQCodeQuotedPriceAboveSafetyThreshold:          "QUOTED_PRICE_ABOVE_SAFETY_THRESHOLD",
		RFQCodeQuotedPriceOutOfRange:                    "QUOTED_PRICE_OUT_OF_RANGE",
		RFQCodeSignedOrderMakerAmountNotPositive:        "SIGNED_ORDER_MAKER_AMOUNT_NOT_POSITIVE",
		RFQCodeSignedOrderMakerDoesNotMatchAuth:         "SIGNED_ORDER_MAKER_DOES_NOT_MATCH_AUTH",
		RFQCodeSignedOrderPriceWorseThanQuote:           "SIGNED_ORDER_PRICE_WORSE_THAN_QUOTE",
		RFQCodeSignedOrderSignatureTypeDoesNotMatchAuth: "SIGNED_ORDER_SIGNATURE_TYPE_DOES_NOT_MATCH_AUTH",
		RFQCodeSignedOrderSignerDoesNotMatchAuth:        "SIGNED_ORDER_SIGNER_DOES_NOT_MATCH_AUTH",
		RFQCodeSignedOrderSizeDoesNotCoverQuote:         "SIGNED_ORDER_SIZE_DOES_NOT_COVER_QUOTE",
		RFQCodeSignedOrderTakerAmountNotPositive:        "SIGNED_ORDER_TAKER_AMOUNT_NOT_POSITIVE",
		RFQCodeSizeE6NotPositive:                        "SIZE_E6_NOT_POSITIVE",
	}
