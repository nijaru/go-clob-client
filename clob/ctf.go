...
func (c *Client) SplitTokens(ctx context.Context, args SplitArgs) error {
...
// Level 2 Auth required.
func (c *Client) MergeTokens(ctx context.Context, args MergeArgs) error {
...
// Level 2 Auth required.
func (c *Client) RedeemTokens(ctx context.Context, args RedeemArgs) error {
