...
const (
	...
	RFQCodeInvalidOrderSide                         RFQErrorCode = "INVALID_ORDER_SIDE"
	RFQCodeInvalidSignatureType                     RFQErrorCode = "INVALID_SIGNATURE_TYPE"
	RFQCodeMissingMakerAddressInQuote               RFQErrorCode = "MISSING_MAKER_ADDRESS_IN_QUOTE"
	RFQCodeMissingMakerAmountInSignedOrder          RFQErrorCode = "MISSING_MAKER_AMOUNT_IN_SIGNED_ORDER"
	RFQCodeMissingMakerInSignedOrder                RFQErrorCode = "MISSING_MAKER_IN_SIGNED_ORDER"
	RFQCodeMissingQuoteID                           RFQErrorCode = "MISSING_QUOTE_ID"
	RFQCodeMissingRFQID                             RFQErrorCode = "MISSING_RFQ_ID"
	RFQCodeMissingSaltInSignedOrder                 RFQErrorCode = "MISSING_SALT_IN_SIGNED_ORDER"
	RFQCodeMissingSignatureInSignedOrder            RFQErrorCode = "MISSING_SIGNATURE_IN_SIGNED_ORDER"
	RFQCodeMissingSignerAddressInQuote              RFQErrorCode = "MISSING_SIGNER_ADDRESS_IN_QUOTE"
	RFQCodeMissingSignerInSignedOrder               RFQErrorCode = "MISSING_SIGNER_IN_SIGNED_ORDER"
	RFQCodeMissingTakerAmountInSignedOrder          RFQErrorCode = "MISSING_TAKER_AMOUNT_IN_SIGNED_ORDER"
	RFQCodeMissingTimestampInSignedOrder            RFQErrorCode = "MISSING_TIMESTAMP_IN_SIGNED_ORDER"
	RFQCodeMissingTokenIDInSignedOrder              RFQErrorCode = "MISSING_TOKEN_ID_IN_SIGNED_ORDER"
	RFQCodeOrderSideOrTokenDoesNotMatchRequest      RFQErrorCode = "ORDER_SIDE_OR_TOKEN_DOES_NOT_MATCH_REQUEST"
	RFQCodePriceE6NotPositive                       RFQErrorCode = "PRICE_E6_NOT_POSITIVE"
	RFQCodeQuotedPriceAboveSafetyThreshold          RFQErrorCode = "QUOTED_PRICE_ABOVE_SAFETY_THRESHOLD"
	RFQCodeQuotedPriceOutOfRange                    RFQErrorCode = "QUOTED_PRICE_OUT_OF_RANGE"
	RFQCodeSignedOrderMakerAmountNotPositive        RFQErrorCode = "SIGNED_ORDER_MAKER_AMOUNT_NOT_POSITIVE"
	RFQCodeSignedOrderMakerDoesNotMatchAuth         RFQErrorCode = "SIGNED_ORDER_MAKER_DOES_NOT_MATCH_AUTH"
	RFQCodeSignedOrderPriceWorseThanQuote           RFQErrorCode = "SIGNED_ORDER_PRICE_WORSE_THAN_QUOTE"
	RFQCodeSignedOrderSignatureTypeDoesNotMatchAuth RFQErrorCode = "SIGNED_ORDER_SIGNATURE_TYPE_DOES_NOT_MATCH_AUTH"
	RFQCodeSignedOrderSignerDoesNotMatchAuth        RFQErrorCode = "SIGNED_ORDER_SIGNER_DOES_NOT_MATCH_AUTH"
	RFQCodeSignedOrderSizeDoesNotCoverQuote         RFQErrorCode = "SIGNED_ORDER_SIZE_DOES_NOT_COVER_QUOTE"
	RFQCodeSignedOrderTakerAmountNotPositive        RFQErrorCode = "SIGNED_ORDER_TAKER_AMOUNT_NOT_POSITIVE"
	RFQCodeSizeE6NotPositive                        RFQErrorCode = "SIZE_E6_NOT_POSITIVE"
)
