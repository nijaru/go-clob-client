...
//   - BUY: amount is USDC notional, accumulate size*price across asks (descending)
//   - SELL: amount is shares, accumulate size across bids (ascending)
...
func TestCalculateMarketPriceBuyFOK(t *testing.T) {
	...
	// amount=5 USDC; 10*0.4=4 < 5, next: 4+20*0.45=13 >= 5, return 0.45
	price, err := client.CalculateMarketPrice(
		ctx, "tok", SideBuy, udecimal.MustParse("5"), OrderTypeFOK,
	)
	if err != nil {
	...
	// amount=20 USDC; 4 < 20, 4+9=13 < 20, 13+30*0.5=28 >= 20, return 0.50
	price, err = client.CalculateMarketPrice(
		ctx, "tok", SideBuy, udecimal.MustParse("20"), OrderTypeFOK,
	)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestCalculateMarketPriceSellFOK(t *testing.T) {
	...
	price, err := client.CalculateMarketPrice(
		ctx, "tok", SideSell, udecimal.MustParse("10"), OrderTypeFOK,
	)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	...
	price, err = client.CalculateMarketPrice(
		ctx, "tok", SideSell, udecimal.MustParse("30"), OrderTypeFOK,
	)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestCalculateMarketPriceInsufficientLiquidity(t *testing.T) {
	...
	_, err := client.CalculateMarketPrice(
		ctx, "tok", SideBuy, udecimal.MustParse("100"), OrderTypeFOK,
	)
	if err == nil {
	...
	price, err := client.CalculateMarketPrice(
		ctx, "tok", SideBuy, udecimal.MustParse("100"), OrderTypeGTC,
	)
	if err != nil {
...
func TestCalculateMarketPriceEdgeCases(t *testing.T) {
	...
	_, err := client.CalculateMarketPrice(
		ctx, "tok", SideBuy, udecimal.Zero, OrderTypeFOK,
	)
	if err == nil {
		t.Fatal("zero amount should error")
	}

	// Exact match: amount = 10 * 0.50 = 5 USDC
	price, err := client.CalculateMarketPrice(
		ctx, "tok", SideBuy, udecimal.MustParse("5"), OrderTypeFOK,
	)
	if err != nil {
