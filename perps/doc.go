...
// WebSocket session are available through NewAuthenticated. Low-level signed
// entry-order, cancel, cancel-all, and leverage commands are available when
// the delegated private key is supplied; TP/SL orchestration and credential
// lifecycle remain separate follow-ups.
//
